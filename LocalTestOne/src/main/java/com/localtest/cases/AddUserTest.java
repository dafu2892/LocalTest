...
import com.localtest.model.AddUserCase;
...
public class AddUserTest {
    ...
    private String getResult(AddUserCase addUserCase) throws IOException {
        ...
        param.put("user_name",addUserCase.getUser_name());
        param.put("user_password",addUserCase.getUser_password());
        param.put("user_age",addUserCase.getUser_age());
        param.put("user_sex",addUserCase.getUser_sex());
